...
export default function PaginaCadastro() {
  ...
  const [urlDelete, setUrlDelete] = useState('https://ws-airbnbclone-1226.herokuapp.com');
            ...
            <table  width={'98%'} className='table'>
              ...
              {dados.map((dados: Imovel) =>{
                ...
                <tr className='evenRow'>
                  ...
                  <form onSubmit={event => {
                      setAcao('tabela')
                      setUrlDelete(`http://localhost:3000/delete`);
                      event.preventDefault();
                  }}
                  style={
                  { 
